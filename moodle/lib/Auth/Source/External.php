 ...
 *
 * * @package    auth_samlidp_v2
 * @copyright  2023 Daniel Seixas
...
use SimpleSAML\Auth\Source as AuthSource;
use SimpleSAML\Error\Exception as SimpleSAML_Exception;
use SimpleSAML\Utilities;


class sspmod_moodle_Auth_Source_External extends AuthSource{
